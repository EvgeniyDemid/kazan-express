...
import ru.kazanexpress.pages.components.LoginPage;
import ru.kazanexpress.pages.components.MainKazanexpressPage;
import ru.kazanexpress.pages.components.ProductstPage;
...
public class KazanexpressTests {
	...
	ProductstPage productstPage = new  ProductstPage();
	@BeforeAll
	...
	public void  displayingNameCatalogWhenGoIt(Catalog product){
		...
		mainKazanexpressPage.clickCatalogProduct(product.value);
		productstPage.checkTitel(product.value);
	}
	@ParameterizedTest
